...
#include "my_turtle_interfaces/msg/detail/turtle_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_my_turtle_interfaces
cdr_serialize(
  const my_turtle_interfaces::msg::TurtleInfo & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_turtle_interfaces::msg::TurtleInfo & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_turtle_interfaces::msg::TurtleInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_turtle_interfaces::msg::TurtleInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_turtle_interfaces::msg::TurtleInfo *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_my_turtle_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<my_turtle_interfaces::msg::TurtleInfo>()
{
  return &my_turtle_interfaces::msg::typesupport_fastrtps_cpp::_TurtleInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_turtle_interfaces, msg, TurtleInfo)() {
  return &my_turtle_interfaces::msg::typesupport_fastrtps_cpp::_TurtleInfo__handle;
}
