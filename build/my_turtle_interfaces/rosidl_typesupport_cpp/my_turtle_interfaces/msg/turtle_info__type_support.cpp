...
static const _TurtleInfo_type_support_symbol_names_t _TurtleInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_turtle_interfaces, msg, TurtleInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_turtle_interfaces, msg, TurtleInfo)),
  }
};
...
{
  return &::my_turtle_interfaces::msg::rosidl_typesupport_cpp::TurtleInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_turtle_interfaces, msg, TurtleInfo)() {
  return get_message_type_support_handle<my_turtle_interfaces::msg::TurtleInfo>();
}
