...
static const _TurtleInfo_type_support_symbol_names_t _TurtleInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_turtle_interfaces, msg, TurtleInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_turtle_interfaces, msg, TurtleInfo)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_turtle_interfaces, msg, TurtleInfo)() {
  return &::my_turtle_interfaces::msg::rosidl_typesupport_c::TurtleInfo_message_type_support_handle;
}
